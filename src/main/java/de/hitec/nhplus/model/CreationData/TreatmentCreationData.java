 ...
 */
public record TreatmentCreationData (long patientId, LocalDate date, LocalTime begin, LocalTime end, String description, String remarks, long caregiverId, long medicineId, LocalDate archivedOn) {
}
