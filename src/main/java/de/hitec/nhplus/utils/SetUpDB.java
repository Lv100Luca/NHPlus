...
public class SetUpDB {
    ...
    private static void setUpTreatments() {
        try {
            ...
            dao.create(new Treatment(1, 1, convertStringToLocalDate("1111-11-11"), convertStringToLocalTime("11:00"), convertStringToLocalTime("15:00"), "Gespräch", "blah", "Caregiver1"));
